  ...
  >
    <el-form ref="formRef" :model="form" :rules="formRules" label-width="100px">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="知识库名称" prop="name">
            <el-input v-model="form.name" placeholder="如 产品文档库" :disabled="isReadonly" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="知识库编码" prop="code">
            <el-input v-model="form.code" placeholder="如 product_docs" :disabled="isReadonly || isEdit" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="描述">
        <el-input v-model="form.description" type="textarea" :rows="2" placeholder="知识库用途说明" :disabled="isReadonly" />
      </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="分片大小">
            <el-input-number v-model="form.chunkSize" :min="100" :max="4096" :step="64" style="width: 100%" :disabled="isReadonly" />
            <div class="form-tip">字符数</div>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="重叠字符">
            <el-input-number v-model="form.chunkOverlap" :min="0" :max="500" :step="10" style="width: 100%" :disabled="isReadonly" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-form-item label="排序号">
        <el-input-number v-model="form.sortOrder" :min="0" :max="999" style="width: 200px" :disabled="isReadonly" />
      </el-form-item>
    </el-form>
    <template #footer>
      <el-button v-if="isReadonly" @click="visible = false">关闭</el-button>
      <el-button v-if="isReadonly" v-permission="'aiModule:aiConfig:knowledgeBase:edit'" type="primary" @click="enterEditMode">编辑</el-button>
...
const dialogTitle = computed(() => {
  if (!isEdit.value) return '新增知识库'
  return isEditing.value ? '编辑知识库' : '知识库详情'
})
